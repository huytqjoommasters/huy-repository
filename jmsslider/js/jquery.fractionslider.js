    ...
    var FractionSlider = function(element, options) {
            ...
            function objectAnimationIn(obj, position, transition, delay, time, easing, special) {
                ...
                timeouts.push(setTimeout(function() {
                    ...
                    obj.css(cssStart).show().animate(cssEnd, speed, easing, function() {
                        objFinished(obj);
                    }).addClass('fs_obj_active').addClass(transform_in + ' animated');
                }, delay));
            }
            ...
            function objectAnimationOut(obj, position, transition, speed, easing) {
                ...
                if(obj.attr('data-transform-out'))
                    var transform_out = obj.attr('data-transform-in');
                else
                ...
                obj.css(cssStart).animate(cssEnd, speed, easing, function() {
                    obj.hide();
                }).addClass(transform_out + ' animated').removeClass('fs_obj_active');
            }
            ...
            function makeResponsive() {
                ...
                dY = d['1'];
                if(options.fullWidth)
                    rdX = $('.slider-wrapper').width();
                else
                    rdX = dX;
                if(options.fullHeight) {
                    dY = $('.slider-wrapper').height();
                }
                if (!options.increase) {
                ...
                objs.each(function() {
                    ...
                    if (obj.attr("data-position-mobile") !== undefined) {
                        ...
                        var my = pixelToPercent(position[0], mdY);

                        obj.attr("data-position-mobile", my + ',' + mx);
                    }
