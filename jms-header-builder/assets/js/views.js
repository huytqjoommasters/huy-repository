    ...
    function(exports, $, _, Backbone) {
        ...
        exports.WRNitro_HeaderBuilder_ItemView = WRNitro_View.extend({
            init: function() {
                ...
                this.listenTo(this.model, "change:centerElement", function() {
                    if (this.model.get("centerElement")) {
                        ...
                        this.model.collection.invoke("set", "centerElement", false, {
                            silent: true
                        });
                        this.model.set("centerElement", true, {
                            silent: true
                        })
                    } else {
                        this.$el.removeAttr("style");
                        this.$el.removeClass("element-center");
                        this.model.set("centerElement", false, {
                            silent: true
                        })
                    }
                });
            ...
            updateCSS: function() {
                ...
                if (this.model.get("style.backgroundImage") !== "undefined" && this.model.get("style.backgroundImage") != " " && this.model.get("style.backgroundImage")) {
                    this.$(".header-item-inner").css({
                        backgroundImage: "url(" + this.model.get("style.backgroundImage") + ")"
                    })
                }
            },
            updateID: function() {
        ...
        exports.WRNitro_HeaderBuilder_ItemsView = B.CollectionView.extend({
                ...
                centerElementTo: function(e, item) {
                    _.delay(_.bind(function() {
                        ...
                        if (this.countEnableCenter > 1) {
                            ...
                            this.collection.invoke("set", "centerElement", false, {
                                silent: true
                            });
                            _.delay(function() {
                                var interval = setInterval(function() {
                                    if (view.lastItem) {
                                        log(view.lastItem);
                                        view.lastItem.set("centerElement", true, {
                                            silent: true
                                        });
            ...
            deselectItems: function() {
                _.invoke(this.collection.where({
                    selected: true
                }), "set", {
                    selected: false
                })
            ...
            itemViews: {
                search: WRNitro_HeaderBuilder_ItemView.extend({
                    ...
                    updateIconCSS: function() {
                        this.$(".icon-button").css({
                            color: this.model.get("iconColor"),
                            fontSize: this.model.get("iconFontSize") + "px"
                        })
                    },
                ...
                menu: WRNitro_HeaderBuilder_ItemView.extend({
                    ...
                    updateLinkCSS: function() {
                        ...
                        if (typeof this.model.get("layoutStyle") !== "undefined" && this.model.get("layoutStyle") == "text") {
                            ...
                            if (typeof this.model.get("link.style.color") !== "undefined" && this.model.get("link.style.color") != " " && this.model.get("link.style.color")) {
                                this.$el.find(".menu-more").css({
                                    color: this.model.get("link.style.color")
                                });
                    ...
                    updateSpacing: function() {
                        ...
                        if (spacing.backgroundImage !== "undefined" && spacing.backgroundImage != " " && spacing.backgroundImage) {
                            log(1234543);
                            this.$(".header-item-inner").css({
                                backgroundImage: "url(" + spacing.backgroundImage + ")"
                            })
                        }
                    }
                }),
                ...
                logo: WRNitro_HeaderBuilder_ItemView.extend({
                    ...
                    renderLogo: function() {
                        var logoType = this.model.get("logoType"),
                            html = "";
                ...
                social: WRNitro_HeaderBuilder_ItemView.extend({
                    ...
                    renderSocial: function() {
                        ...
                        if (iconColor === "") {
                            ...
                            if (iconStyle === "custom" && backgroundColor === "") {
        ...
        exports.WRNitro_HeaderBuilder_InspectorView = WRNitro_View.extend({
            ...
            updateContentModeTextEditor: function(e) {
                var _this = $(e.currentTarget);
                var content = window.switchEditors._wp_Autop(_this.val());
            ...
            openMediaBox: function(e) {
                ...
                e.preventDefault();
                var $btn = $(selector),
                    frame = $btn.data("wr_media_selector"),
                    $input = $(selector).parent().find("input.input-file");
                if (!frame) {
                    log("Not has frame");
                    frame = wp.media({
                        button: {
            ...
            views: {
                "rowsView collection:rows > .hb-rows": WRNitro_HeaderBuilder_RowsView.extend({
                    ...
                    changeSticky: function(item, collection, options) {
                        if (item.get("sticky")) {
                            this.collection.invoke("set", "sticky", false, {
                                silent: true
                            });
                            item.set({
                                sticky: true
                ...
                if (file) {
                    if (this.checkFileAPI) {
                        ...
                        read.onloadend = function() {
                            if (/^[\],:{}\s]*$/.test(contents.replace(/\\["\\\/bfnrtu]/g, "@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g, "]").replace(/(?:^|:|,)(?:\s*\[)+/g, ""))) {
